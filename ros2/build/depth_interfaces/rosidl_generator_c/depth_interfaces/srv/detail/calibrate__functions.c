...
depth_interfaces__srv__Calibrate_Request__create()
{
  ...
  depth_interfaces__srv__Calibrate_Request * msg = (depth_interfaces__srv__Calibrate_Request *)allocator.allocate(sizeof(depth_interfaces__srv__Calibrate_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(depth_interfaces__srv__Calibrate_Request));
  bool success = depth_interfaces__srv__Calibrate_Request__init(msg);
  if (!success) {
...
depth_interfaces__srv__Calibrate_Request__destroy(depth_interfaces__srv__Calibrate_Request * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    depth_interfaces__srv__Calibrate_Request__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
depth_interfaces__srv__Calibrate_Request__Sequence__init(depth_interfaces__srv__Calibrate_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  depth_interfaces__srv__Calibrate_Request * data = NULL;

  if (size) {
    data = (depth_interfaces__srv__Calibrate_Request *)allocator.zero_allocate(size, sizeof(depth_interfaces__srv__Calibrate_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = depth_interfaces__srv__Calibrate_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        depth_interfaces__srv__Calibrate_Request__fini(&data[i - 1]);
      }
...
depth_interfaces__srv__Calibrate_Request__Sequence__fini(depth_interfaces__srv__Calibrate_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      depth_interfaces__srv__Calibrate_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  depth_interfaces__srv__Calibrate_Request__Sequence * array = (depth_interfaces__srv__Calibrate_Request__Sequence *)allocator.allocate(sizeof(depth_interfaces__srv__Calibrate_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = depth_interfaces__srv__Calibrate_Request__Sequence__init(array, size);
  if (!success) {
...
depth_interfaces__srv__Calibrate_Request__Sequence__destroy(depth_interfaces__srv__Calibrate_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    depth_interfaces__srv__Calibrate_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
depth_interfaces__srv__Calibrate_Request__Sequence__are_equal(const depth_interfaces__srv__Calibrate_Request__Sequence * lhs, const depth_interfaces__srv__Calibrate_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!depth_interfaces__srv__Calibrate_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  depth_interfaces__srv__Calibrate_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(depth_interfaces__srv__Calibrate_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    depth_interfaces__srv__Calibrate_Request * data =
      (depth_interfaces__srv__Calibrate_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!depth_interfaces__srv__Calibrate_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          depth_interfaces__srv__Calibrate_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!depth_interfaces__srv__Calibrate_Request__copy(
...
depth_interfaces__srv__Calibrate_Response__init(depth_interfaces__srv__Calibrate_Response * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->message)) {
    depth_interfaces__srv__Calibrate_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  depth_interfaces__srv__Calibrate_Response * msg = (depth_interfaces__srv__Calibrate_Response *)allocator.allocate(sizeof(depth_interfaces__srv__Calibrate_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(depth_interfaces__srv__Calibrate_Response));
  bool success = depth_interfaces__srv__Calibrate_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
depth_interfaces__srv__Calibrate_Response__Sequence__init(depth_interfaces__srv__Calibrate_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  depth_interfaces__srv__Calibrate_Response * data = NULL;

  if (size) {
    data = (depth_interfaces__srv__Calibrate_Response *)allocator.zero_allocate(size, sizeof(depth_interfaces__srv__Calibrate_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = depth_interfaces__srv__Calibrate_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        depth_interfaces__srv__Calibrate_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
depth_interfaces__srv__Calibrate_Response__Sequence__fini(depth_interfaces__srv__Calibrate_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      depth_interfaces__srv__Calibrate_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  depth_interfaces__srv__Calibrate_Response__Sequence * array = (depth_interfaces__srv__Calibrate_Response__Sequence *)allocator.allocate(sizeof(depth_interfaces__srv__Calibrate_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = depth_interfaces__srv__Calibrate_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
depth_interfaces__srv__Calibrate_Response__Sequence__destroy(depth_interfaces__srv__Calibrate_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    depth_interfaces__srv__Calibrate_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
depth_interfaces__srv__Calibrate_Response__Sequence__are_equal(const depth_interfaces__srv__Calibrate_Response__Sequence * lhs, const depth_interfaces__srv__Calibrate_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!depth_interfaces__srv__Calibrate_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  depth_interfaces__srv__Calibrate_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(depth_interfaces__srv__Calibrate_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    depth_interfaces__srv__Calibrate_Response * data =
      (depth_interfaces__srv__Calibrate_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!depth_interfaces__srv__Calibrate_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          depth_interfaces__srv__Calibrate_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!depth_interfaces__srv__Calibrate_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }

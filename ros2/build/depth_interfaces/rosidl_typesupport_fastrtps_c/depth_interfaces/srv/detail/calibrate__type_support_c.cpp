...
#include "depth_interfaces/srv/detail/calibrate__rosidl_typesupport_fastrtps_c.h"
...
using _Calibrate_Request__ros_msg_type = depth_interfaces__srv__Calibrate_Request;
...
size_t get_serialized_size_depth_interfaces__srv__Calibrate_Request(
  const void * untyped_ros_message,
...
static uint32_t _Calibrate_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_depth_interfaces__srv__Calibrate_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_depth_interfaces
size_t max_serialized_size_depth_interfaces__srv__Calibrate_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = depth_interfaces__srv__Calibrate_Request;
    is_plain =
      (
...
static size_t _Calibrate_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_depth_interfaces__srv__Calibrate_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, depth_interfaces, srv, Calibrate_Request)() {
...
using _Calibrate_Response__ros_msg_type = depth_interfaces__srv__Calibrate_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_depth_interfaces
size_t get_serialized_size_depth_interfaces__srv__Calibrate_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Calibrate_Response__ros_msg_type * ros_message = static_cast<const _Calibrate_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_depth_interfaces__srv__Calibrate_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_depth_interfaces
size_t max_serialized_size_depth_interfaces__srv__Calibrate_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = depth_interfaces__srv__Calibrate_Response;
    is_plain =
      (
...
static size_t _Calibrate_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_depth_interfaces__srv__Calibrate_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, depth_interfaces, srv, Calibrate_Response)() {
...
// already included above
// #include "depth_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "depth_interfaces/srv/calibrate.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, depth_interfaces, srv, Calibrate)() {

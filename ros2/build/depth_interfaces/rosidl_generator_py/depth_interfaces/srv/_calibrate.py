...
class Metaclass_Calibrate(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'depth_interfaces.srv.Calibrate')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from depth_interfaces.srv import _calibrate
...
class Calibrate(metaclass=Metaclass_Calibrate):
    from depth_interfaces.srv._calibrate import Calibrate_Request as Request
    from depth_interfaces.srv._calibrate import Calibrate_Response as Response

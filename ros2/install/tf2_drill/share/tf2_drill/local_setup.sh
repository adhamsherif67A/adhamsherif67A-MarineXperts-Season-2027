...
: ${AMENT_CURRENT_PREFIX:="/ros2_ws/install/tf2_drill"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/tf2_drill/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/tf2_drill/environment/path.sh"
